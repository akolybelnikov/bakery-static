;(function() {
  ...
  this.ipayCheckout = function(
    ...
    function createIframe(order) {
      ...
      iframe.src =
        "https://3dsec.sberbank.ru/payment/docsite/payform-1.html?token=" +
        options.api_token +
        "&modal=true&order=" +
        encodeURIComponent(orderStr)
    ...
    function gotEvent(e) {
      var data = e.data,
        offset =
          parseInt(iframe.getAttribute("data-offset")) || window.pageYOffset,
      ...
      switch (data.type) {
        case "LOADED":
          ...
          if (data) {
             ...
             */
            document
              .getElementById(options.api_token)
